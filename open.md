...
This is the Open Chart system. We also have a [Basic Chart
...
-   2♣️! 11+ points, 5+♣️s. May be done with only 4 clubs and a
    slam-seeking hand to get information about opener’s hand rather than
    immediately jumping to quant. Generally denies a 4 card major unless
    game forcing values. Somewhat artificial rebids:
...
-   2♦️! 11+ points, 5+♦️s, may be done with only 4 diamonds and a slam
    seeking hand. Similar rebids as after 2♣️:
    -   2♥️! Any minimum
        -   2♠️! Artificial game force
