This is the Open Chart system. We also have a [Basic Chart system](basic.md)
for use in Basic and Basic+ events.

This system diverges from usual Precision variants in its 1♦️, 2♣️, and 2♦️
openings. See [this writeup for an exposition of the
